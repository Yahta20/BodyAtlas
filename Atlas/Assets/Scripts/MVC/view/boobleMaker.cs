...
public class boobleMaker : MonoBehaviour
{
    ...
    private void updateFoo(Vector2 screenSize)
    {
        ...
        rtPanel.sizeDelta = new Vector2(screenSize.x+RightPanel.anchoredPosition.x- RightPanel.sizeDelta.x,
                                        screenSize.y);
        ListManager();
    ...
    // Start is called before the first frame update
            //var publishing = ClassroomBeh.Instance.nameOfChosen.
